...
<div class="header">
    <div class="header-inner">
        ...
        <div class="menu_icon"><span class="menu_icon_start" style="display:none"></span><span class="close_icon"
    ...
    <div class="main" id="main">
        ...
        <div class="testing-box" id="testingBox">
            ...
            <div class="testing-send">
                ...
                <script id="templateFormList" type="text/html">
                    <li>
                        ...
                        <input class="testing-param-val" type="text" value="{{default}}"
                               placeholder="请输入参数值 ({{valueType}})" {{required}}/>
                        <big>*</big>
                    </li>
                </script>
                    ...
                    <div class="testing-global" id="testingGlobal">
                        <div class="testing-global-param"><i class="close">&times;</i>
                            ...
                            <script id="templateGlobalParam" type="text/html">
                                <li><i>&times;</i>
                                    描述：<input type="text" placeholder="describe" value="{{describe}}"><br>
                                    参数名：<input type="text" placeholder="key-name" value="{{keyName}}"><br>
                                    参数值：<input type="text" placeholder="value" value="{{value}}">
                                </li>
                            </script>
                            <div class="btn">
                                <div class="testing-global-working"><span>启用</span><span>禁用</span><i></i></div>
            ...
            <div class="testing-response">
                <iframe id="testingResponse" width="100%" frameborder="0" border="0" marginwidth="0"
                        marginheight="0" scrolling="no" allowtransparency="yes" framespacing="0"></iframe>
            </div>
        </div>
    </div>
</div>
