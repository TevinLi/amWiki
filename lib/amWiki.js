...
//手动刷新工具
var makeNav = require('../src/makeNav');
//自动化工具
var automatic = require('../src/automatic');
//wiki创建器
var creator = require('../src/creator');
//页内目录创建器
var catalogue = require('../src/catalogue');
//截图粘帖模块
var pasterImg = require('../src/pasterImg');
//本地服务器模块
var webServer = require('../src/webServer');
//项目导出模块
var exportGithub = require('../src/export.github');
//文件拖拽模块
var fileDrop = require('../src/fileDrop');
