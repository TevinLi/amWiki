...
module.exports = {
    ...
    make: function () {
        ...
        //分析markdown的页内目录
        var navText = this.extract(editor.document.getText()) || '';
        //将所得文本插入到当前光标处
        editor.edit(function (editoBuilder) {
            editoBuilder.delete(editor.selection);
        }).then(function () {
            editor.edit(function (editoBuilder) {
                editoBuilder.insert(editor.selection.start, navText);
            });
        });
