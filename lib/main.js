...
//手动刷新工具
var makeNav = require('../build/makeNav');
//自动化工具
var automatic = require('../build/automatic');
//wiki创建器
var creator = require('../build/creator');
//页内目录创建器
var catalogue = require('../build/page-catalogue');
//截图粘帖模块
var pasterImg = require('../build/pasterImg');
//本地服务器模块
var webServer = require('../build/webServer');
//项目导出模块
var exportGithub = require('../build/export-github');
//文件拖拽模块
var fileDrop = require('../build/fileDrop');
