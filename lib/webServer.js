...
module.exports = {
    ...
    createServer: function () {
        ...
        this.server = http.createServer(function (req, res) {
            ...
            var mappingId = '';
            var file = pathname.replace(/^\/wiki(\d{3,}?)\//g, function (match, $1) {
                mappingId = 'wiki' + $1;
                return ''
            });
            ...
            try {
                ...
                file = GBK.decode(file);
            }
            //真实地址
            var realPath = that.mappingList[mappingId] + file;
            //解析文件
    ...
    browser: function (list) {
        ...
        var filePath = editorPath.split('library\\')[1].replace('\\', '/').replace('.md', '');
        var url = host + '/wiki' + mappingId + '/index.html?file=' + filePath;
        var cmd;
        ...
        //console.log(editorPath.split('library')[0], cmd + ' "' + url + '"');
