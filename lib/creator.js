        ...
        fs.readdir(options.outputPath, function (err, files) {
            ...
            if (!hasLibrary) {
                ...
                var fileList2 = [
                    ...
                    ['doc.markdown.md', 'library/02-学习markdown/001-Markdown快速开始.md'],
                    ['doc.highlighting.md', 'library/02-学习markdown/002-Markdown与语法高亮.md'],
                    ['doc.atommd.md', 'library/02-学习markdown/003-Atom默认对markdown的支持.md'],
                    ['doc.apidemo.md', 'library/03-文档示范/001-通用API接口文档示例.md'],
                    ['doc.longarticle.md', 'library/03-文档示范/002-超长文档页内目录示例.md']
                ];
